...
import (
	...
	"micro-go-book/ch13-seckill/sk-admin/endpoint"
	"micro-go-book/ch13-seckill/sk-admin/plugins"
	"micro-go-book/ch13-seckill/sk-admin/service"
	"micro-go-book/ch13-seckill/sk-admin/transport"
	"micro-go-book/ch13-seckill/user-service/config"
	"net/http"
	"os"
	"os/signal"
	"syscall"
