...
import (
	...
	localconfig "micro-go-book/ch13-seckill/user-service/config"
	"micro-go-book/ch13-seckill/user-service/endpoint"
	"micro-go-book/ch13-seckill/user-service/plugins"
	"micro-go-book/ch13-seckill/user-service/service"
	"micro-go-book/ch13-seckill/user-service/transport"
	"net"
	"net/http"
	"os"
	"os/signal"
