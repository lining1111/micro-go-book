...
import (
	...
	"micro-go-book/ch13-seckill/gateway/config"
	"micro-go-book/ch13-seckill/pb"
	"micro-go-book/ch13-seckill/pkg/client"
	"micro-go-book/ch13-seckill/pkg/discover"
	"micro-go-book/ch13-seckill/pkg/loadbalance"
	"net/http"
	"net/http/httputil"
	"strings"
	"sync"
